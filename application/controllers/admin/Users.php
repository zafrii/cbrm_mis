...
class Users extends MY_Controller {
	...
	public function datatable_json(){				   					   
		...
		{  
			...
			$admin_approval = ($row['admin_approval'] == 1)? 'checked': '';
			...
			$data[]= array(
				...
				'<input class="tgl_checkbox1 tgl-ios" 
				data-id="'.$row['id'].'" 
				id="cb1_'.$row['id'].'"
				type="checkbox"  
				'.$admin_approval.'><label for="cb1_'.$row['id'].'"></label>',	
	...
	function change_admin_approval()
	{   
		$this->user_model->change_admin_approva();
	}
