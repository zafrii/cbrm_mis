...
<body class="hold-transition sidebar-mini <?=  (isset($bg_cover)) ? 'bg-cover' : '' ?>">
      ...
      <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
                  ...
                  <ul class="navbar-nav">
                        ...
                        <li class="nav-item d-none d-sm-inline-block">
                              <a href="<?= base_url('user') ?>" class="nav-link"><?= trans('home') ?></a>
                        </li>
                        <li class="nav-item d-none d-sm-inline-block">
                              <a href="<?= base_url('user/auth/logout') ?>" class="nav-link"><?= trans('logout') ?></a>
                        </li>
                  </ul>
            ...
            <?php $this->load->view('user/includes/_sidebar'); ?>
