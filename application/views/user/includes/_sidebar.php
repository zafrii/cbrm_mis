      ...
      <div class="sidebar">
        ...
        ?>
                        ...
                        <li id="<?= ($nav['controller_name']) ?>"
                              ...
                              <a href="<?= base_url('user/'.$nav['controller_name']) ?>" class="nav-link">
          ...
          ?>
                              <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                          <a href="<?= base_url('user/'.$nav['controller_name'].'/'.$sub_nav['link']); ?>"
                                                class="nav-link">
                        ...
                        <?php if($this->session->userdata('admin_approval') == '1'): ?>
                        <li id="orders" class="nav-item  has-treeview  has-treeview">
                              <a href="<?= base_url('user/orders') ?>" class="nav-link">
                              ...
                              <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                          ...
                                          <a href="<?= base_url('user/orders/add'); ?>" class="nav-link">
                                                <i class="fa fa-circle-o nav-icon"></i>
                                                <p>Create Order</p>
                                          </a>
                                    </li>
                        ...
                        <li class="nav-item">
                              <a href="<?= base_url('user/agreement') ?>" class="nav-link">
                                    <i class="nav-icon fa fa-file"></i>
                                    <p>Agreement</p>
                              </a>
                        </li>
